...
data class BarScalePeaks(
    ...
    val ramTemp1: Float? = null,
    val ramTemp2: Float? = null,
    ...
    fun absorb(dashboard: DashboardSnapshot): Pair<BarScalePeaks, Boolean> {
        ...
        val next = copy(
            ...
            driveC = bump(driveC, dashboard.driveCTemp),
            driveD = bump(driveD, dashboard.driveDTemp),
            driveE = bump(driveE, dashboard.driveETemp),
